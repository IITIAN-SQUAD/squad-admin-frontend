  ...
  return <>
    ...
    <PageWrapper>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mt-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Active exam configurations</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Papers created</p>
          </CardContent>
        </Card>
      ...
      <div className="mt-6">
        <Card>
          <CardHeader>
            <CardTitle>Welcome to IITian Squad Admin</CardTitle>
            <CardDescription>
              Manage exams, papers, questions, and more from this dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
